...
class UserController extends Controller {
    ...
    async resetPassword({ request, response }) {
        ...
        let expiry_link_date = moment(getResetPassReq.reset_passwords[0].createdAt).add(1, 'hours');
        //check expiry
        ...
        await UserApiToken.deleteRecord(getResetPassReq.slug);
    ...
    async resetPasswordSubmit({ request, response }) {
        ...
        try {
            await user.updateResetPassword(request.body);
